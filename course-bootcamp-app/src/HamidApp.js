...
function HamidApp() {
  ...
  return (
    <div className="HamidApp">
      ...
      {/* <Contact name="Hamid Sarfaraz" position="TDP" YOE={1} image={b2}/>
      <Contact name="Mayank Dwivedi" position="Manager" YOE={13} image={b3}/>
      <Contact name="Gupta Milan" position="SDE" YOE={10} image={b4}/>
      <Contact name="Aparna Kolanu"  position="Team Leader" YOE={10} image={b5}/>
      <Contact name="New Comer"  position="" YOE={0} image={b6}/>  */}
    </div>
  );
}
